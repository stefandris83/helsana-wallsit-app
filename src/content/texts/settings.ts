...
export const settingsContent = defineContent({
  ...
  'legal.privacyPolicy.text': {
    owner: 'privacy',
    text: 'Diese Pilotversion speichert alle Angaben ausschliesslich auf Ihrem Gerät. Es werden keine Daten an einen Server übermittelt. Für die Pilotauswertung stellt Helsana ausschliesslich anonymisierte Nutzungsdaten zusammen: ohne Namen, ohne Kontaktangaben, ohne Freitextnotizen und ohne einzelne Blutdruckzahlen. Sie können Ihre Daten jederzeit exportieren und löschen. Verantwortlich für die Pilotdurchführung ist das Projektteam von Helsana.',
  },
