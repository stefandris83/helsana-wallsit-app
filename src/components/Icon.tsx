...
const paths: Record<IconName, string> = {
  ...
  'shield-check':
    'M12 2C15 2 22 4.3 22 6.8V10.5C22 16.5 16.5 21 12.4 22C12.1 22.1 11.9 22.1 11.6 22C7.5 21 2 16.5 2 10.5V6.8C2 4.3 9 2 12 2ZM11.1 15.6l-2.7-2.7a0.8 0.8 0 0 1 1.1-1.1l2.2 2.2 4.2-4.2a0.8 0.8 0 0 1 1.1 1.1l-4.8 4.8a0.8 0.8 0 0 1-1.1 0z',
};
